...
交互上，当前支持两种缩放入口：
- 鼠标悬停在宠物面板上滚动滚轮，按 `0.1x` 步进缩放
- 在设置面板中通过滑条调整 `1.0x ~ 20.0x`
- 缩放会作用到整套宠物舞台，包含宠物面板、气泡、历史/设置/聊天面板、评分牌和字体
- 主窗口会按 `scale` 同步放大，不额外使用固定显示框裁切内部内容
